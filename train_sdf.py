...
if __name__ == '__main__':
    ...
    train_dataset = SDFDataset(opt.path, size=100, num_samples=2**18, clip_sdf=CLIP_SDF)
    valid_dataset = SDFDataset(opt.path, size=1, num_samples=2**18, clip_sdf=CLIP_SDF) # just a dummy
