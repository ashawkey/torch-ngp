...
#OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=1 python main_nerf.py data/nerf_synthetic/lego --workspace trial_nerf_gui_lego --cuda_ray --bound 1 --scale 0.8 --mode blender --gui
