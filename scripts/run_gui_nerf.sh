...
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=1 python main_nerf.py data/figure --workspace trial_nerf_ff2_figure --fp16 --ff --cuda_ray --gui --scale 1.0 --dt_gamma 0.0039 --preload