...
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=2 python main_nerf.py data/firekeeper --workspace trial_nerf_test --preload --bound 1.0 --scale 0.33 --bg_radius 32 #--gui --test