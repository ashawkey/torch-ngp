...
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=7 python main_nerf.py data/nerf_synthetic/lego --workspace trial_nerf_lego_sab -O --bound 1.0 --scale 0.8 --dt_gamma 0 --mode blender
