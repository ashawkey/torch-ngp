...
#OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=1 python train_nerf.py data/fox/transforms.json --workspace trial_nerf --fp16 --cuda_raymarching
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=1 python train_nerf.py data/fox/transforms.json --workspace trial_nerf_ff --fp16 --ff --cuda_raymarching
